...
def main (args):
        ...
        if i == 0:
                ...
                directory = '/var/www/html/testoutputs/' + hostname.upper()
                if not os.path.exists(directory):
                        os.makedirs(directory)
                filename = '/var/www/html/testoutputs/' + hostname.upper() + '/' + changenum + '-' + hostname.upper() + '-' + date +'-testplan_outputs.txt'
                url = 'http://156.150.222.39/testoutputs/' + hostname.upper() + '/' + changenum + '-' + hostname.upper() + '-' + date +'-testplan_outputs.txt'
                ...
                child.expect ('[a-zA-Z0-9-]+#')
                tests (test, child)
                print '#Output complete log saved as ' + url+ ''
                child.sendcontrol('m')
